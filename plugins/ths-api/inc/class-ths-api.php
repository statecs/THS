  ...
  public static function get_social_posts( WP_REST_Request $request) {
    ...
    if ($type == instagram) {
     //$string = file_get_contents("/storage/content/63/101063/ths.kth.se/public_html/wp-content/plugins/ths-api/instagram_mockup.json");
      $string = file_get_contents("https://api.instagram.com/v1/media/search?lat=59.347313&lng=18.071340&access_token=3632648868.0efbe26.487ecc304b774eaebf25e46d948455c9&distance=100&count=55");
